      ...
      <div className="bg-orange-600 px-4 py-4 sticky top-0 z-50 shadow-lg">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex space-x-4">
            ...
            <Link href="/tabela" className="px-3 py-2 text-white hover:bg-orange-700 rounded font-bold">
              Tabela
            </Link>
            <Link href="/empresas" className="px-3 py-2 bg-orange-700 text-white font-bold rounded">
              Empresas
            </Link>
          </div>
        </div>
